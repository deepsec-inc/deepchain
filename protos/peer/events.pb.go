...
func (*FilteredBlock) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_390eb89af6aac1c6, []int{0}
}
...
func (*FilteredTransaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_390eb89af6aac1c6, []int{1}
}
...
func (*FilteredTransactionActions) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_390eb89af6aac1c6, []int{2}
}
...
func (*FilteredChaincodeAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_390eb89af6aac1c6, []int{3}
}
...
func (*DeliverResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_events_390eb89af6aac1c6, []int{4}
}
...
func init() { proto.RegisterFile("peer/events.proto", fileDescriptor_events_390eb89af6aac1c6) }

var fileDescriptor_events_390eb89af6aac1c6 = []byte{
	// 553 bytes of a gzipped FileDescriptorProto
	,
}
