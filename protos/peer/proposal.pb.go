...
import fmt "fmt"
import math "math"
import token "deepchain/protos/token"
...
func (*SignedProposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposal_893d74460045d2de, []int{0}
}
...
func (*Proposal) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposal_893d74460045d2de, []int{1}
}
...
func (*ChaincodeHeaderExtension) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposal_893d74460045d2de, []int{2}
}
...
func (*ChaincodeProposalPayload) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposal_893d74460045d2de, []int{3}
}
...
func (*ChaincodeAction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposal_893d74460045d2de, []int{4}
}
...
func init() { proto.RegisterFile("peer/proposal.proto", fileDescriptor_proposal_893d74460045d2de) }

var fileDescriptor_proposal_893d74460045d2de = []byte{
	// 480 bytes of a gzipped FileDescriptorProto
	,
}
