...
import (
	...
	"deepchain/integration/nwo"
	"deepchain/integration/nwo/commands"
	"deepchain/integration/nwo/fabricconfig"
...
var _ = Describe("EndToEnd", func() {
	...
	BeforeEach(func() {
		...
		chaincode = nwo.Chaincode{
			Name:    "mycc",
			Version: "0.0",
			Path:    "deepchain/integration/chaincode/simple/cmd",
...
func compilePlugin(pluginType string) string {
	...
	cmd := exec.Command(
		...
		"-o", pluginFilePath,
		fmt.Sprintf("deepchain/integration/pluggable/testdata/plugins/%s", pluginType),
	)
