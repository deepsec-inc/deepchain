...
func Test_findSource(t *testing.T) {
	...
	source, err = findSource(gopath, "deepchain/peer")
	if err != nil {
...
func Test_DeploymentPayload(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("deepchain/examples/chaincode/go/example02/cmd")
...
func Test_DeploymentPayloadWithStateDBArtifacts(t *testing.T) {
	...
	payload, err := platform.GetDeploymentPayload("deepchain/examples/chaincode/go/marbles02")
	assert.NoError(t, err)
...
func TestValidatePath(t *testing.T) {
	...
	var tests = []struct {
		...
		{path: "deepchain/examples/chaincode/go/map", succ: true},
		{path: "deepchain/bad/chaincode/go/map", succ: false},
...
func TestGetDeploymentPayload(t *testing.T) {
	...
	var tests = []struct {
		...
		{gopath: defaultGopath, path: "deepchain/examples/chaincode/go/map", succ: true},
		{gopath: defaultGopath, path: "deepchain/examples/bad/go/map", succ: false},
...
func TestGenerateDockerBuild(t *testing.T) {
	...
	tests := []struct {
		...
		{gopath: defaultGopath, spec: spec{CCName: "map", Path: "deepchain/examples/chaincode/go/map", SuccessExpected: true, RealGen: true}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadPath", Path: "deepchain/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric/examples/bad/path/to/map.go", Mode: 0100400, SuccessExpected: false}},
		{gopath: defaultGopath, spec: spec{CCName: "mapBadMode", Path: "deepchain/examples/chaincode/go/map", File: "/src/github.com/hyperledger/fabric/examples/chaincode/go/map/map.go", Mode: 0100555, SuccessExpected: false}},
